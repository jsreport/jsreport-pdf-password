...
PdfPassword.prototype.addPassword = function (request, response) {
  ...
  var id = uuid()
  var originalPdfFile = path.join(this.tempAutoCleanupDirectory, id + '-without-password.pdf')
  var withPasswordPdfFile = path.join(this.tempAutoCleanupDirectory, id + '-with-password.pdf')
